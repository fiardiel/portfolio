...
const Navbar = () => {
    ...
    return (
        <div className={`w-auto flex justify-center sticky md:top-0 z-50 pt-2 lg:pt-5`}>
            <nav className={`rounded-full hidden md:flex lg:inline-flex border-1 md:w-full lg:w-auto z-48 items-center h-20 transition duration-500 ${!isScrolled ? 'bg-transparent border-transparent' : 'border-white/5 shadow-xl bg-neutral-900/60 backdrop-blur-md'}  lg:justify-center`}>
