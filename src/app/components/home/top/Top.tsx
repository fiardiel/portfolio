      ...
      <Reveal>
        <div className="lg:gap-16 flex items-center">
          <div className="flex flex-col lg:w-3/5 items-start">
            <div>
              <h1 className={`text-4xl md:text-5xl`}>Hello<span className="text-blue-600">, World!</span></h1>
              <h1 className='text-4xl md:text-5xl'><span>I&apos;m </span> <span className='font-semibold'>Rafi Ardiel Erinaldi</span></h1>
              ...
              <p className="text-sm mb-4 mt-3 font-light text-gray-400 md:text-lg text-start">
                ...
                Developer Intern at <Link href="https://www.linkedin.com/company/samakta-mitra---itaas/" className="text-sm md:text-lg transition-colors duration-300 hover:opacity-100 underline-animation underline-animation-red text-primary hover:text-white"> PT. Samakta Mitra</Link>
              </p>
            </div>
            ...
            <div className='flex justify-center md:justify-start gap-5'>
              {socialLinks.map((item, index) => (
                <Tooltip key={index} content={item.name}>
                  <Link href={item.href} className='transition hover:opacity-100 hover:-translate-y-1 hover:scale-105 mb-2'>
