...
const Skills = ({ className }: SkillsProps) => {
  const skills = [
    {
      title: 'Full-stack ',
      description: "I am experienced in building responsive and interactive web applications using modern web   technologies. I am experienced in building responsive and interactive web applications using modern techologies, including RESTful APIs and backends using various frameworks and languages, including CMS.",
      logo: <FrontendIcon className='h-[150px] text-neutral-400 fill-neutral-400 translate-x-1' />
    },
    {
      title: 'Data ',
      description: "I've done several machine learning tasks, including natural language processing, classification, and clustering. I've handled multiple datasets starting from synthetically generated tweets to Knowledge Graph of Wikidata using several python libraries.",
